...
interface KiwiHuntGridCellSkeletonProps {
    animationDelay: string;
}

const KiwiHuntGridCellSkeleton: React.FC<KiwiHuntGridCellSkeletonProps> = ({ animationDelay }) => {
    return (
        <div
...
export default KiwiHuntGridCellSkeleton;