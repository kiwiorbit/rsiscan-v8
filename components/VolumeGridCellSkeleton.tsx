...
interface VolumeGridCellSkeletonProps {
    animationDelay: string;
}

const VolumeGridCellSkeleton: React.FC<VolumeGridCellSkeletonProps> = ({ animationDelay }) => {
    return (
        <div
...
export default VolumeGridCellSkeleton;