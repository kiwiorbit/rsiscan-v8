...
interface WaveTrendGridCellSkeletonProps {
    animationDelay: string;
}

const WaveTrendGridCellSkeleton: React.FC<WaveTrendGridCellSkeletonProps> = ({ animationDelay }) => {
    return (
        <div
...
export default WaveTrendGridCellSkeleton;