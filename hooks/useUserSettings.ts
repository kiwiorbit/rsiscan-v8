...
const useUserSettings = () => {
    ...
    const handleSortChange = useCallback(() => {
        setSortOrder(prev => {
            ...
            if (currentView === 'waveTrend') {
                if (prev === 'default') return 'waveTrend-desc';
                if (prev === 'waveTrend-desc') return 'waveTrend-asc';
                return 'default';
            }
            if (currentView === 'kiwiHunt') {
                if (prev === 'default') return 'kiwiHunt-desc';
    ...
    const handleNavigateToStochFullView = useCallback(() => setPage('stoch-full-view'), []);
    ...
    return {
        ...
        handleSaveAssetList, handleNavigateToFullView, handleNavigateToStochFullView, handleNavigateBack, handleResetSettings, handleTimeframeChange
    };
};
